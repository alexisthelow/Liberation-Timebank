...
public interface ServiceControllerInterface {
	...
	public ServiceOffer createServiceOffer(HttpSession session, HttpServletResponse res, @PathVariable int timebankId, @RequestBody String offerJson);
	...
	public ServiceRequest createServiceRequest(HttpSession session, HttpServletResponse res, @PathVariable int timebankId, @RequestBody String requestJson);
	...
	public ServiceRequestActivity updateServiceRequestActivity(HttpSession session, HttpServletResponse res, @PathVariable int requestId, @PathVariable int activityId);
