...
public interface ItemDAO {
	...
	public Transaction parentUserAccept(int actingUserId, Transaction transaction);
	public Transaction parentUserReject(int actingUserId, Transaction transaction);
	public Transaction parentUserComplete(int actingUserId, Transaction transaction);
	public Transaction ownerComplete(int actingUserId, Transaction transaction);
	public Transaction determineLoanDates(Loan loan);
	public Loan renewLoan(int actingUserId, Loan loan);
